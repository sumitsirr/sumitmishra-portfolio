            ...
            {projects.map((project, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className={`absolute top-4 right-4 bg-gradient-to-r ${project.gradient} text-white px-3 py-1 rounded-full text-sm font-medium`}>
                    {project.subtitle}
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1">
                      {project.role.map((roleItem, roleIndex) => (
                        <li key={roleIndex} className="flex items-start text-gray-600 text-sm">
